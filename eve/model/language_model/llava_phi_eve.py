...
class EveLLaVAPhiConfig(PhiConfig):
    ...
    def __init__(self,
        ...
        super(EveLLaVAPhiConfig, self).__init__(**kwargs)


class EveLLaVAPhiModel(LlavaMetaModel, PhiModel):
    config_class = EveLLaVAPhiConfig

    def __init__(self, config: PhiConfig):
        super(EveLLaVAPhiModel, self).__init__(config)
...
def EvePhiDecoderLayer_forward(self):
    def forward(
            # self,
        ...
        # hidden_states.shape torch.Size([1, 645, 2560])
        ...
        # len(hidden_states)
        # hidden_states[0].shape torch.Size([1, 645, 2560])
        # hidden_states[1].shape torch.Size([]) tensor(1.0122, device='cuda:0')
        # hidden_states[2].shape torch.Size([2]) tensor([207, 438])
        moe_losses = []
...
class EveLLaVAPhiForCausalLM(PhiForCausalLM, LlavaMetaForCausalLM):
    config_class = EveLLaVAPhiConfig

    def __init__(self, config):
        super(PhiForCausalLM, self).__init__(config)
        self.model = EveLLaVAPhiModel(config)
    ...
    def initialize_moe_modules(self, model_args):
        ...
        for m in self.model.layers:
            m.forward = EvePhiDecoderLayer_forward(m)
        rank0_print(f'replace PhiDecoderLayer.forward to EvePhiDecoderLayer.forward')
        self.model.forward = EvePhiModel_forward(self.model)
        rank0_print(f'replace PhiModel.forward to EvePhiModel.forward')



class EvalEveLLaVAPhiForCausalLM(EveLLaVAPhiForCausalLM):
    config_class = EveLLaVAPhiConfig

    def __init__(self, config):
        super(EvalEveLLaVAPhiForCausalLM, self).__init__(config)
...
AutoConfig.register("moe_llava_phi", EveLLaVAPhiConfig)
AutoModelForCausalLM.register(EveLLaVAPhiConfig, EveLLaVAPhiForCausalLM)
AutoModelForCausalLM.register(EveLLaVAPhiConfig, EvalEveLLaVAPhiForCausalLM)
