...
class LlavaZhiziConfig(InternLMConfig):
    model_type = "llava_zhizi"
    
class LlavaZhiziModel(LlavaMetaModel, InternLMModel):
    config_class = LlavaZhiziConfig

    def __init__(self, config: InternLMConfig):
        super(LlavaZhiziModel, self).__init__(config)

class LlavaZhiziForCausalLM(InternLMForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaZhiziConfig

    def __init__(self, config):
        super(InternLMForCausalLM, self).__init__(config)
        self.model = LlavaZhiziModel(config)
...
AutoConfig.register("llava_zhizi", LlavaZhiziConfig)
# AutoTokenizer.register(LlavaPhiConfig, PhiTokenizer)
AutoModelForCausalLM.register(LlavaZhiziConfig, LlavaZhiziForCausalLM)
