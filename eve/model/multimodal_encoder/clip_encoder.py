...
class CLIPVisionTower(nn.Module):
    ...
    def load_model(self):
        print("CLIPVisionTower load_model")
...
if __name__ == '__main__':
    ...
    clip_ckpt = '/home/ma-user/work/project/LMM/Eve-LLaVA_lossgd/models/vision_model/clip-vit-large-patch14-336'
    args = {'mm_vision_select_layer': -2 }
    # args.mm_vision_select_layer = -2

    clip = CLIPVisionTower(clip_ckpt)


    x = torch.ones([1,3,336,336])
    y = clip(x)
    print(y.shape)