...
# from eve.model.language_model.llava_qwen_moe import EvalEveLLaVAQWenForCausalLM
# from eve.model.language_model.llava_qwen import LlavaQWenForCausalLM

from eve.model.language_model.llava_zhizi_moe import EvalEveLlavaZhiziForCausalLM
from eve.model.language_model.llava_zhizi import LlavaZhiziForCausalLM

from eve.model.language_model.llava_llama_moe import EvalEveLLaVALlamaForCausalLM
from eve.model.language_model.llava_llama import LlavaLlamaForCausalLM

import transformers
a, b, c = transformers.__version__.split('.')[:3]
if a == '4' and int(b) >= 34:
    from eve.model.language_model.llava_mistral_moe import EvalEveLLaVAMistralForCausalLM
    from eve.model.language_model.llava_mistral import LlavaMistralForCausalLM
if a == '4' and int(b) >= 36:
    from eve.model.language_model.llava_minicpm_moe import EvalEveLLaVAMiniCPMForCausalLM
    from eve.model.language_model.llava_minicpm import LlavaMiniCPMForCausalLM
    from eve.model.language_model.llava_phi_moe import EvalEveLLaVAPhiForCausalLM
    from eve.model.language_model.llava_phi import LlavaPhiForCausalLM
    from eve.model.language_model.llava_stablelm_moe import EvalEveLLaVAStablelmForCausalLM
    from eve.model.language_model.llava_stablelm import LlavaStablelmForCausalLM
if a == '4' and int(b) >= 37:
    from eve.model.language_model.llava_qwen1_5_moe import EvalEveLLaVAQwen1_5ForCausalLM
    from eve.model.language_model.llava_qwen1_5 import LlavaQwen1_5ForCausalLM
...
from eve.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, \
    DEFAULT_VID_END_TOKEN, DEFAULT_VID_START_TOKEN, DEFAULT_VIDEO_PATCH_TOKEN
from eve.model.language_model.qwen.tokenization_qwen import QWenTokenizer
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto",
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and 'moe' not in model_name.lower() and model_base is not None:
            ...
            if 'qwen' in model_base.lower() and '1.5' not in model_base.lower():
                ...
                model.config.eos_token_id = tokenizer.eos_token_id
                tokenizer = AutoTokenizer.from_pretrained(model_base, use_fast=False, padding_side=padding_side)
            elif 'zhizi' in model_base.lower():
                tokenizer = transformers.LlamaTokenizer.from_pretrained(model_base,use_fast=False, padding_side=padding_side)
                model = LlavaZhiziForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
            ...
            print("✅ The mm_projector is loaded successful!")
            ...
            if 'qwen' in model_name.lower() and '1.5' not in model_name.lower():
                ...
                model = EvalEveLLaVAQWenForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
                ...
                model = EvalEveLLaVAMistralForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
            elif 'qwen' in model_name.lower() and '1.5' in model_name.lower():
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalEveLLaVAQwen1_5ForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                # import ipdb
                # ipdb.set_trace()
                model.config.eos_token_id = tokenizer.eos_token_id
            elif 'phi' in model_name.lower():
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalEveLLaVAPhiForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            elif 'zhizi' in model_name.lower():
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalEveLlavaZhiziForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            elif 'minicpm' in model_name.lower():
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalEveLLaVAMiniCPMForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            elif 'stablelm' in model_name.lower():
                from eve.model.language_model.stablelm.tokenization_arcade100k import Arcade100kTokenizer
                tokenizer = Arcade100kTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalEveLLaVAStablelmForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
                model.config.eos_token_id = tokenizer.eos_token_id
            else:
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False, padding_side=padding_side)
                model = EvalEveLLaVALlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
            if not merge:
                import deepspeed
            ...
            # =============================================================================================
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalEveLLaVAMistralForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalEveLLaVAPhiForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalEveLLaVAQwen1_5ForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalEveLLaVAMiniCPMForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                from eve.model.language_model.stablelm.tokenization_arcade100k import Arcade100kTokenizer
                from eve.model.language_model.stablelm.configuration_stablelm_epoch import StableLMEpochConfig
                ...
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalEveLLaVAStablelmForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                cfg_pretrained = AutoConfig.from_pretrained(model_path)
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalEveLLaVAQWenForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                cfg_pretrained = AutoConfig.from_pretrained(model_path)
                if getattr(cfg_pretrained, 'moe', {}).get('moe_enable', False):
                    model = EvalEveLLaVALlamaForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
            ...
            if 'mpt' in model_name.lower():
                ...
                if 'moe' in model_name.lower():
                    ...
                    model = EvalEveLLaVAQWenForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalEveLLaVAMistralForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalEveLLaVAPhiForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                tokenizer = transformers.LlamaTokenizer.from_pretrained(model_path, use_fast=False)

                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalEveLlavaZhiziForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                    ...
                    model = LlavaZhiziForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalEveLLaVAMiniCPMForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalEveLLaVAStablelmForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    # Initialize the DeepSpeed-Inference engine
                    ds_engine = deepspeed.init_inference(model,
                ...
                if 'moe' in model_name.lower():
                    assert not load_8bit and not load_4bit  # FIXME
                    model = EvalEveLLaVALlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                    import deepspeed
                    deepspeed.init_distributed(dist_backend='nccl')
                    print(model)
                    # Initialize the DeepSpeed-Inference engine
    ...
    # torch.save(model.state_dict(), "/home/ma-user/work/project/LMM/result/moe-llava/eve_zhizi_wolora/llavaZhizi-1.5b-2.finetune_new/pytorch_model.bin")
