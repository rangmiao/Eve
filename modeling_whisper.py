...
class WhisperEncoder(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        hidden_states = nn.functional.dropout(hidden_states, p=self.dropout, training=self.training)
        #print('hidden_states after + embed_pos', hidden_states.size())
        #print(input_features_length[0])
        hidden_states = hidden_states[:,:input_features_length[0],:] 
        ...
        #print('hidden_states before attention', hidden_states)
        ...
        #print('hidden_states after ln', hidden_states)
        if output_hidden_states:
            encoder_states = encoder_states + (hidden_states,)
...
class WhisperModel(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        input_features_length: Optional[int] = None,
        attention_mask: Optional[torch.LongTensor] = None,
